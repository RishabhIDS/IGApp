import 'dart:math';
import 'package:igapp/screens/ig_about_ids.dart';
...
class DeveloperModel {
  ...
  DeveloperModel(
      this.image, this.name, this.role, this.profile, this.LinkedInLink);
}

List<DeveloperModel> dataList = [
  DeveloperModel("developersPhoto/bhushanbahale.jpg", "Bhushan Bahale",
      "RestAPI(President)", "", ""),
  DeveloperModel(
      "developersPhoto/bhupendratiwari.jpg",
      "Bhupendra Tiwari",
      "Project Head,Backend Developer",
      "https://www.instagram.com/bhupendratiwarionline/",
      ""),
  DeveloperModel(
      "developersPhoto/harshada1.jpg",
      "Harshada Polshetty",
      "Shared Preferences,App Ui",
      "https://www.instagram.com/harsha_polshetty/",
      ""),
  DeveloperModel("developersPhoto/DhairyaSuryawanshi_App2ndyr.jpg",
      "Dhairya Suryawanshi", "App Ui", "", ""),
  DeveloperModel(
      "developersPhoto/vaidehi.jpg", "Vaidehi Kharde", "App Ui", "", ""),
];
